    ...
    <div class="sidebar-content js-simplebar">
      ...
      <ul class="sidebar-nav">
        ...
        <li class="sidebar-item active">
          <a class="sidebar-link" href="../views/admin/product.jsp">
            ...
            <nav class="navbar navbar-expand-lg bg-light">
              <div class="container-fluid">
                ...
                <form action="<%=request.getContextPath()%>/ProductServlet" >
                  <input class="form-control me-2 fst-italic" name="searchName"  type="search" placeholder="Enter product's name... "
                         aria-label="Search">
            ...
            <table id="example1" class="table table-bordered table-striped text-center">
              ...
              <c:forEach items="${listProduct}" var="pro">
                <tr>
                  ...
                  <td><img style="width: 50px;height: 50px" src="<%=request.getContextPath()%>/images/${pro.productImages}"/></td>
                  <td>${pro.title}</td>
                  <td>${pro.quantity}</td>
                  <td>${pro.price}</td>
